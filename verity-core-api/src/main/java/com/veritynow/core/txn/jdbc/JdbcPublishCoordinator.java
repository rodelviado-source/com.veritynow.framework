...
public class JdbcPublishCoordinator implements PublishCoordinator {
    ...
    public JdbcPublishCoordinator(JdbcTemplate jdbc, TransactionFinalizer finalizer) {
        this.jdbc = Objects.requireNonNull(jdbc, "jdbc");
        this.finalizer = Objects.requireNonNull(finalizer, "store");
    }
    ...
    public void onCommit(String txnId, UUID lockGroupId, long fenceToken) {
        ...
        finalizer.commit(txnId, lockGroupId, fenceToken, jdbc);
    }
