...
create index "ix_vn_lock_group_active_expires_partial" on "public"."vn_lock_group"("expires_at");
create index "ix_vn_lock_group_active_owner_partial" on "public"."vn_lock_group"("owner_id");
...
create index "ix_vn_path_lock_active_group_partial" on "public"."vn_path_lock"("lock_group_id");
create index "ix_vn_path_lock_active_owner_partial" on "public"."vn_path_lock"("owner_id");
create index "ix_vn_path_lock_active_scope_key_gist" on "public"."vn_path_lock"("scope_key");
...
create unique index "uq_vn_path_lock_active_group_scope" on "public"."vn_path_lock"("lock_group_id", "scope_key");
create index "ix_vn_txn_epoch_lock_group" on "public"."vn_txn_epoch"("lock_group_id");
