...
drop index if exists "ix_vn_lock_group_active_expires_partial" cascade;
drop index if exists "ix_vn_lock_group_active_owner_partial" cascade;
drop index if exists "ix_vn_lock_group_owner_active" cascade;
drop index if exists "ix_vn_path_lock_active_group_partial" cascade;
drop index if exists "ix_vn_path_lock_active_owner_partial" cascade;
drop index if exists "ix_vn_path_lock_active_scope_key_gist" cascade;
drop index if exists "ix_vn_path_lock_group" cascade;
drop index if exists "ix_vn_path_lock_owner_active" cascade;
drop index if exists "ix_vn_txn_epoch_lock_group" cascade;
drop index if exists "ix_vn_txn_epoch_status" cascade;
drop index if exists "uq_vn_path_lock_active_group_scope" cascade;
