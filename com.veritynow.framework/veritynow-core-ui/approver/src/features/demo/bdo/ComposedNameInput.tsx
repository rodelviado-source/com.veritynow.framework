...
import { RecordItem } from "./RecordsTable";
...
export type ClientNameOnly = Omit<RecordItem, 
      "id" | "requirements" | "priority" | "status" | "uploadStatus" | "loadedStatus" | "createdAt" | "assetIds"
    | "agentId" | "agentFirstName" | "agentMiddleName" | "agentLastName" | "agentSuffix"
    | "clientId"
 >;
